...
function Recover()
{
    ...
    return(
        ...
        <form onSubmit={findEmail} className="recoverField">
                ...
                <span className="innerText">Enter the e-mail address associated with your account:</span><br />
                ...
                <input type="submit" id="submitButton" className="submitButton" value ="Send recovery code" onClick={findEmail} />
