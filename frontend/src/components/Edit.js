...
function Edit()
{
   ...
   return(
        ...
        <table>
        <td className = "col1">
            <input type="text" id="title" defaultValue={title} className="titlefield" ref={(c) => title = c} /><br />
            <textarea id="description" className="descfield" defaultValue={description} ref={(c) => description = c}/>
            <div className="lists">
        </div>
		...
		<div className="lists">
            ...
            <input type="submit" id="submitButton" className="submitBut" value ="Save Recipe" onClick={editRecipe} />
        </form>
        </div>
   );
};
